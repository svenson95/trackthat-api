...
import com.svenson95.trackthat_api.database.mapper.WorkoutMapper;
import com.svenson95.trackthat_api.database.model.Workout;
import com.svenson95.trackthat_api.database.model.Workout.ListItem;
import com.svenson95.trackthat_api.database.repository.WorkoutRepository;
...
public class WorkoutService {
  ...
  public List<WorkoutDTO> updateAllWorkouts(String userId, List<WorkoutDTO> workoutsDto) {
    ...
    List<Workout> existingWorkouts = workoutRepository
        .findByUserId(userId)
        .orElseThrow(() -> new RuntimeException("Workout not found"));
